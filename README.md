# 🔥 BoomBim - 실시간 유동인구 히트맵

실시간 유동인구 데이터를 지도에 시각적으로 표시하는 React 기반 웹 애플리케이션입니다.

## ✨ 주요 기능

- **실시간 히트맵**: 유동인구 밀도에 따른 지도 색상 변화
- **핫스팟 표시**: 인구 급증 지역에 🔥 아이콘 애니메이션
- **상세 정보**: 지역 클릭 시 인구 통계 및 변화율 모달
- **10분 자동 업데이트**: React Query를 통한 실시간 데이터 동기화
